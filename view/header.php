                        ...
                        <div class="col-xl-6 col-lg-4">
                            <div class="ht-right d-flex justify-content-lg-end justify-content-center">
                                <ul class="ht-us-menu d-flex">
                                    ...
                                    <li class="boxcontent formtaikhoan"><a href="#"><i class="fa fa-user-circle-o"></i>Đăng Nhập</a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li><a href="index.php?act=feedback">About Us</a></li>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 order-lg-3 order-md-3 order-2 d-flex justify-content-end">
                            ...
                            <div class="header-cart">
                                <a href="index.php?act=cart"><i class="fa fa-shopping-cart"></i><span></span></a>
                            </div>
                        </div>
                        <!--Search Cart End-->
                    </div>
