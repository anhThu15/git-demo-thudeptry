                        ...
                        <div class="col-xl-6 col-lg-4">
                            <div class="ht-right d-flex justify-content-lg-end justify-content-center">
                                <ul class="ht-us-menu d-flex">
                                    ...
                                    <li class="boxcontent formtaikhoan"><a href="#"><i class="fa fa-user-circle-o"></i>Admin</a>
                                        <ul class="ht-dropdown right">
                                            <!-- <li><a href="compare.html">Compare Products</a></li> -->
                                            <li><a href="index.php?act=login">My Account</a></li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3 col-6 order-lg-1 order-md-1 order-1">
                            <div class="logo">
                                <a href="../controller/index.php"><img src="../view/images/logo.png" width="60px" height="60px" alt="logo TG shop"></a>
                            </div>
                        </div>
                        <!--Logo end-->
                        ...
                        <div
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li><a href="index.php?act=categories">Categories</a>
                                        <!-- 
                                        ...
                                        --></li>
                                    <li><a href="index.php?act=taikhoan">Statisticals</a></li>
                                    <li><a href="index.php?act=hienthi">Product</a></li>
                                    <li><a href="../index.php">Shop</a></li>
                                    <li><a href="index.php?act=orders">Oders</a></li>
                                    <li><a href="index.php?act=stas">Stas</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!--Menu end-->
                        ...
                        <div class="col-lg-3 col-md-3 col-6 order-lg-3 order-md-3 order-2 d-flex justify-content-end">
                            ...
                            <div class="header-cart">
                                <a href="index.php?act=cart"><i class="fa fa-shopping-cart"></i><span>3</span></a>
                            </div>
                        </div>
                        <!--Search Cart End-->
                    </div>
